...
<g>
  ...
  <div class="modal fade" id="cartModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" v-if="!cartOpen">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header border-bottom-0">
          ...
          <button type="button" @click="closeCart" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <div class="modal-body">
          <table class="table table-image">
            ...
            <tbody>
              <tr>
                <td class="w-25">
                  <img src="../assets/camp.jpg" class="img-fluid img-thumbnail" alt="Sheep">
                </td>
                <td>wfwf</td>
                <td>$334</td>
              </tr>
          ...
          <div class="d-flex justify-content-end">
            <h5>Total: <span class="price text-success">$333</span></h5>
          </div>
        </div>
