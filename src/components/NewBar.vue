...
const user = {
  name: 'Dev Abd',
  email: 'abd@shopesy.com',
  imageUrl:
    'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
}
const navigation = [
  { name: 'Dashboard', href: '/admin-board', current: true },
  { name: 'Products', href: '/admin-board/view-products', current: false },
  { name: 'Add Product', href: '/admin-board/add-product', current: false }
]
